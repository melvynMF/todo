...
const cliLib = require("../../polymer-cli");
suite('args', () => {
            ...
            for (const command of commands) {
                ...
                for (const arg of command.args) {
                    ...
                    if (arg.defaultOption) {
                        chai_1.assert.isNull(defaultOption, `multiple default options for ` +
                    ...
                    if (globalArg) {
                        for (const prop of Object.keys(arg)) {
                            ...
                            if (globalValue) {
                                chai_1.assert.equal(globalValue, commandValue, `conflicting values for ${command.name} ${name}.${prop}`);
                            }
                        }
                    }
                }
