...
<html lang="en">
<head>
    <title>Code coverage report for legacy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> legacy.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  //
  function <span class="fstat-no" title="function not covered" >transportError(</span>err) {
<span class="cstat-no" title="statement not covered" >    self.emit('error', err, self.transport);</span>
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.transport.__winstonError) {
 ...
 */
LegacyTransportStream.prototype._write = <span class="fstat-no" title="function not covered" >fu</span>nction (info, enc, callback) {
  //
  ...
  //
<span class="cstat-no" title="statement not covered" >  if (!this.level || this.levels[this.level] &gt;= this.levels[info.level]) {</span>
<span class="cstat-no" title="statement not covered" >    this.transport.log(info.level, info.message, info, <span class="fstat-no" title="function not covered" >fu</span>nction () {});</span>
  }
&nbsp;
 ...
 * with this instance.
 */
LegacyTransportStream.prototype.close = <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >  if (this.transport.close) {</span>
<span class="cstat-no" title="statement not covered" >    this.transport.close();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this.transport.__winstonError) {</span>
<span class="cstat-no" title="statement not covered" >    this.transport.removeListener('error', this.transport.__winstonError);</span>
  }
};
&nbsp;</pre></td></tr>
</table></pre>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Mar 19 2017 14:55:18 GMT-0400 (EDT)
</div>
</div>
