...
class DomModuleInvalidAttrs extends rule_1.HtmlRule {
    constructor() {
        super(...arguments);
    ...
    checkDocument(document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const domModule of badModules) {
                const isFixable = !(dom5.getAttribute(domModule, 'is') !== null &&
                ...
                for (const badAttr of ['is', 'name']) {
                    ...
                    const sourceRange = document.sourceRangeForAttributeName(domModule, badAttr);
              ...
              to associate the tagName of an element with its dom-module.`),
                        severity: polymer_analyzer_1.Severity.WARNING, sourceRange, fix,
                    }));
                }
            }
            return warnings;
...
registry_1.registry.register(new DomModuleInvalidAttrs());
//# sourceMappingURL=dom-module-invalid-attrs.js.map