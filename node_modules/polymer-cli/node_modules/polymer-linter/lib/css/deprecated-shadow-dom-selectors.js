...
class DeprecatedShadowPiercingCombinators extends rule_1.CssRule {
    constructor() {
        super(...arguments);
        this.code = 'deprecated-shadow-dom-selectors';
                ...
                if (node.type === shady.nodeType.ruleset) {
                    ...
                    while ((match = deprecatedCombinatorsRegex.exec(node.selector)) !==
                        ...
                        warnings.push(new polymer_analyzer_1.Warning({
                            ...
                            message: 'The /deep/ (>>>) combinator and ::shadow pseudo-element ' +
...
registry_1.registry.register(new DeprecatedShadowPiercingCombinators());
//# sourceMappingURL=deprecated-shadow-dom-selectors.js.map