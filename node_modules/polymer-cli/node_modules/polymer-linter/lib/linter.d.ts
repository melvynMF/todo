...
export declare class Linter {
     ...
     */
    lint(files: string[], options?: AnalyzeOptions): Promise<LintResult>;
    lintPackage(options?: AnalyzeOptions): Promise<LintResult>;
    private _lintDocuments(documents, cancelToken?);
    private _analyzeAll(files, options?);
