            ...
            for (const elementLike of elementLikes) {
                ...
                for (const method of classBody.body) {
                    ...
                    if (!doesCallSuper(method, methodName)) {
                        ...
                        const parsedDocumentContaining = util_1.getDocumentContaining(elementLike.sourceRange, document);
...
function getClassBody(astNode) {
    ...
    babel_traverse_1.default(astNode, {
        noScope: true,
        enter(path) {
