...
exports.nonModuleScript = dom5_1.predicates.AND(dom5_1.predicates.hasTagName('script'), dom5_1.predicates.OR(dom5_1.predicates.NOT(dom5_1.predicates.hasAttr('type')), dom5_1.predicates.hasAttrValue('type', 'text/javascript'), dom5_1.predicates.hasAttrValue('type', 'application/javascript')));
exports.moduleScript = dom5_1.predicates.AND(dom5_1.predicates.hasTagName('script'), dom5_1.predicates.hasAttrValue('type', 'module'));
...
exports.externalNonModuleScript = dom5_1.predicates.AND(dom5_1.predicates.hasAttr('src'), exports.nonModuleScript);
exports.inlineNonModuleScript = dom5_1.predicates.AND(dom5_1.predicates.NOT(dom5_1.predicates.hasAttr('src')), exports.nonModuleScript);
exports.externalModuleScript = dom5_1.predicates.AND(dom5_1.predicates.hasAttr('src'), exports.moduleScript);
...
exports.orderedImperative = dom5_1.predicates.OR(exports.eagerHtmlImport, exports.nonModuleScript, exports.styleMatcher, exports.externalStyle, exports.polymerExternalStyle);
