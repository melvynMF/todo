        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const myVisitor = (node) => {
                if (isJsScriptNode(node)) {
                    ...
                    if (src) {
                        features.push(new html_script_tag_1.ScannedScriptTagImport(src, document.sourceRangeForNode(node), document.sourceRangeForAttributeValue(node, 'src'), { language: 'html', node, containingDocument: document }, dom5.getAttribute(node, 'type') === 'module'));
                    }
                    else {
