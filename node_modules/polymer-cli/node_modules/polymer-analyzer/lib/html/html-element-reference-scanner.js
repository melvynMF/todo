        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const visitor = (node) => {
                if (node.tagName && this.matches(node)) {
                    const element = new element_reference_1.ScannedElementReference(node.tagName, document.sourceRangeForNode(node), { language: 'html', containingDocument: document, node });
                    if (node.attrs) {
