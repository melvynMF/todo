        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield visit((node) => {
                if (isDomModule(node)) {
                    ...
                    if (template) {
                        ...
                        localIds =
                            [...dom5.queryAll(templateContent, dom5.predicates.hasAttr('id'))]
                                .map((e) => new polymer_element_1.LocalId(dom5.getAttribute(e, 'id'), document.sourceRangeForNode(e), e.nodeName));
                    ...
                    domModules.push(new ScannedDomModule(dom5.getAttribute(node, 'id'), node, document.sourceRangeForNode(node), { language: 'html', node, containingDocument: document }, warnings, template, slots, localIds, databindings));
                }
            });
